...
preact.h("p",null,
preact.h("button",{"class":"button",name:"refresh",onClick:this.refresh},preact.h("i",{"class":"fa fa-refresh"})," Refresh")," ",preact.h("span",{style:Dex.getPokemonIcon('sceptile')+';display:inline-block;vertical-align:middle',"class":"picon",title:"Sceptile is not SPC's mascot! Sceptile is cool, and represents our battles."})),
