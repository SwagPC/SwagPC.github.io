 ...
 *
 * @author Guangcong Luo <guangcongluo@gmail.com>, swagsirej@gmail.com
 * @license MIT
 */var
...
if(format.includes('swagmons')){
if(format.includes('doubles')){
this.formatType='swagmondoubles';
}else{
this.formatType='swagmons';
}
format=format.slice(8);
this.dex=Dex.mod('gen8swagmons');
}
if(format.includes('nationaldex')||format.startsWith('nd')||format.includes('natdex')){
if(format.startsWith('supernatdex')){
format=format.slice(11);
this.formatType='supernatdex';
}else if(format.startsWith('supernationaldex')){
format=format.slice(16);
this.formatType='supernatdex';
}else if(format.startsWith('nationaldexdoubles')){
format='doublesou';
this.formatType='natdexdoubles';
}else if(format.startsWith('nationaldexvgc')){
format='ndvgc';
this.formatType='natdexdoubles';
}else{
...
firstLearnsetid=function firstLearnsetid(speciesid){var _this$formatType,_this$formatType2,_this$formatType3;
...
if((_this$formatType2=this.formatType)!=null&&_this$formatType2.startsWith('swagmons'))table=table['swagmons'];
if((_this$formatType3=this.formatType)!=null&&_this$formatType3.startsWith('supernatdex'))table=table['snatdex'];
...
canLearn=function canLearn(speciesid,moveid){var _this$formatType4,_this$formatType5;
var move=this.dex.moves.get(moveid);
if(((_this$formatType4=this.formatType)!=null&&_this$formatType4.includes('natdex')||(_this$formatType5=this.formatType)!=null&&_this$formatType5.includes('nationaldex'))&&
...
while(learnsetid){var _this$formatType6,_this$formatType7,_this$formatType8;
var table=BattleTeambuilderTable;
if((_this$formatType6=this.formatType)!=null&&_this$formatType6.startsWith('bdsp'))table=table['gen8bdsp'];
if((_this$formatType7=this.formatType)!=null&&_this$formatType7.startsWith('swagmons'))table=table['swagmons'];
if((_this$formatType8=this.formatType)!=null&&_this$formatType8.startsWith('supernatdex'))table=table['snatdex'];
...
getTier=function getTier(pokemon){var _this$formatType9,_this$formatType10;
if(this.formatType==='metronome'||(_this$formatType9=this.formatType)!=null&&_this$formatType9.includes('natdex')||(_this$formatType10=
this.formatType)!=null&&_this$formatType10.includes('swagmons')){
...
getBaseResults=function getBaseResults(){var _this$formatType11,_this$formatType12,_this$formatType13,_this$formatType14,_this$formatType15,_this$formatType16;
var format=this.format;
if(!format)return this.getDefaultResults();
var isVGCOrBS=format.startsWith('battlespot')||format.startsWith('battlestadium')||
format.startsWith('vgc')||format.startsWith('ndvgc');
var isDoublesOrBS=isVGCOrBS||((_this$formatType11=this.formatType)==null?void 0:_this$formatType11.includes('doubles'));
var dex=this.dex;
...
if(format==='ndvgc'){
table=table['natdexvgc'];
}else{
table=table['gen'+dex.gen+'vgc'];
}
}else if(
table['gen'+dex.gen+'doubles']&&dex.gen>4&&this.formatType!=="natdexdoubles"&&
...
table=table['gen'+dex.gen];
}else if((_this$formatType12=this.formatType)!=null&&_this$formatType12.startsWith('bdsp')){
table=table['gen8'+this.formatType];
}else if(this.formatType==='letsgo'){
table=table['gen7letsgo'];
}else if((_this$formatType13=this.formatType)!=null&&_this$formatType13.startsWith('swagmons')){
table=table[this.formatType];


}else if(this.formatType==='supernatdex'){
table=table['snatdex'+this.formatType.slice(11)];
}else if((_this$formatType14=this.formatType)!=null&&_this$formatType14.startsWith('natdex')){
table=table[this.formatType];
}else if(this.formatType==='metronome'){
table=table['metronome'];
}else if(this.formatType==='nfe'){
table=table['gen'+dex.gen+'nfe'];
}else if((_this$formatType15=this.formatType)!=null&&_this$formatType15.startsWith('dlc1')){
...
}else if(format.includes('anythinggoes')||format.endsWith('ag')||format.startsWith('ag')){
tierSet=tierSet.slice(slices.AG);
}else if(format.includes('hackmons')||format.endsWith('bh'))tierSet=tierSet.slice(slices.AG||slices.Uber);else
if(format==='monotype')tierSet=tierSet.slice(slices.Uber);else
...
if((_this$formatType16=this.formatType)!=null&&_this$formatType16.startsWith('bdsp')||this.formatType==='letsgo'||this.formatType==='stadium'){
...
if((format==='anythinggoesuu'||format==='aguu')&&table.aguuBans){
tierSet=tierSet.filter(function(_ref6){var type=_ref6[0],id=_ref6[1];
if(id in table.aguuBans)return false;
return true;
});
}
}
...
getDefaultResults=function getDefaultResults(){var _this$formatType17,_this$formatType18,_this$formatType19,_this$formatType20;
var table=BattleTeambuilderTable;
if((_this$formatType17=this.formatType)!=null&&_this$formatType17.startsWith('bdsp')){
table=table['gen8bdsp'];
}else if((_this$formatType18=this.formatType)!=null&&_this$formatType18.startsWith('natdex')){
table=table['natdex'];




}else if((_this$formatType19=this.formatType)!=null&&_this$formatType19.startsWith('supernatdex')){
table=table['snatdex'];
}else if((_this$formatType20=this.formatType)!=null&&_this$formatType20.startsWith('swagmons')){
table=table['swagmons'];
}else if(this.formatType==='metronome'){
table=table['metronome'];
...
getBaseResults=function getBaseResults(){var _this$formatType21,_this$formatType22,_this$formatType23,_this$formatType24;
if(!this.species)return this.getDefaultResults();
var dex=this.dex;
var species=dex.species.get(this.species);
var format=this.format;
...
if((_this$formatType21=this.formatType)!=null&&_this$formatType21.startsWith('bdsp'))lsetTable=lsetTable['gen8bdsp'];
if(this.formatType==='letsgo')lsetTable=lsetTable['gen7letsgo'];
if((_this$formatType22=this.formatType)!=null&&_this$formatType22.startsWith('dlc1'))lsetTable=lsetTable['gen8dlc1'];
if((_this$formatType23=this.formatType)!=null&&_this$formatType23.startsWith('supernatdex'))lsetTable=lsetTable['snatdex'];

if((_this$formatType24=this.formatType)!=null&&_this$formatType24.startsWith('swagmons'))lsetTable=lsetTable['swagmons'];
while(learnsetid){
var learnset=lsetTable.learnsets[learnsetid];
if(learnset){
for(var moveid in learnset){var _this$formatType25,_this$formatType26,_BattleTeambuilderTab;
...
if(
(_this$formatType26=this.formatType)!=null&&_this$formatType26.startsWith('dlc1')&&(_BattleTeambuilderTab=
...
if(sketch){var _this$formatType27;
if(_move.noSketch||_move.isMax||_move.isZ)continue;
if(_move.isNonstandard&&_move.isNonstandard!=='Past')continue;
if(_move.isNonstandard==='Past'&&!((_this$formatType27=this.formatType)!=null&&_this$formatType27.includes('natdex')))continue;
sketchMoves.push(_move.id);
}else{var _this$formatType28,_this$formatType29;
if(!(dex.gen<8||(_this$formatType28=this.formatType)!=null&&_this$formatType28.includes('natdex'))&&_move.isZ)continue;
if(typeof _move.isMax==='string')continue;
if(_move.isNonstandard==='Past'&&!((_this$formatType29=this.formatType)!=null&&_this$formatType29.includes('natdex')))continue;
...
var valid=false;for(var _i11=0;_i11<
moveTypes.length;_i11++){var type=moveTypes[_i11];
...
var usableMoves=[];
var uselessMoves=[];for(var _i12=0,_moves=
moves;_i12<_moves.length;_i12++){var _id12=_moves[_i12];
...
sketchMoves.length;_i13++){var _id13=sketchMoves[_i13];
...
var move=this.dex.moves.get(row[1]);for(var _i14=0;_i14<
